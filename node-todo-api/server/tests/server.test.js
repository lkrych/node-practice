...
describe('DELETE /todos/:id', () => {
  ...
  it('should not remove a todo if user did not create it', (done) => {
...
describe("PATCH /todos/:id", () => {
  ...
  it("shouldn't update the todo if not authorized", (done) => {
    var id = todos[0]._id.toHexString();
    request(app)
      .patch(`/todos/${id}`)
      .send({text: "Completed to true", completed: true})
...
describe('POST /users', () => {
  ...
  it('should not create user if email in use', (done) => {
    var email = users[0].email; //from seed
    ...
    request(app)
      ...
      .end((err, res) => {
        ...
        User.findById(users[1]._id).then((user) => {
          ...
          }).catch((e) => done(e)); //in the case the tokens aren't equal
      });
  });
